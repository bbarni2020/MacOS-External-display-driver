...
env DISPLAY="$DISPLAY" \
  ...
  DESKEXTEND_SOCKET_RCVBUF=33554432 \
  DESKEXTEND_SOCKET_CHUNK_SIZE=524288 \
  DESKEXTEND_STREAM_DROP_BACKLOG_BYTES=6291456 \
  DESKEXTEND_STREAM_KEEP_LATEST_FRAMES=2 \
  DESKEXTEND_DECODER_QUEUE_BUFFERS=2 \
  DESKEXTEND_DECODER_MAX_LATENESS_NS=20000000 \
  "$DEST/venv/bin/python" "$DEST/receiver.py" --name "$DISPLAY_NAME" --mode "$MODE"
